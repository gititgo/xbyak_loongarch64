...
CXX_FLAGS1="-std=c++11 -fomit-frame-pointer -Wall -fno-operator-names -I../xbyak_loongarch64 -I./ -Wall -Wextra -Wformat=2 -Wcast-qual -Wcast-align -Wwrite-strings -Wfloat-equal -Wpointer-arith -Wno-ignored-qualifiers"
CXX_FLAGS2="-std=c++11 -Wall -I../xbyak_loongarch64 -DXBYAK_TEST -DXBYAK_USE_MMAP_ALLOCATOR"
...
set_variables() {
  ...
  case $ENV_SELECT in
    f) GPP=FCC;
       CXX_FLAGS1="-std=c++11 -fomit-frame-pointer -Wall -fno-operator-names -I../xbyak_loongarch64 -I./ -Wall -Wextra -Wformat=2 -Wcast-qual -Wcast-align -Wwrite-strings -Wfloat-equal -Wpointer-arith -Nclang -Knolargepage -Wno-ignored-qualifiers";
       CXX_FLAGS2="-Wall -I../xbyak_loongarch64 -DXBYAK_TEST -DXBYAK_USE_MMAP_ALLOCATOR -Nclang -Knolargepage";
...
${GPP} ${CXX_FLAGS2} -o nm_frame nm_frame.cpp ../lib/libxbyak_loongarch64.a
if [ $? != 0 ] ;then
